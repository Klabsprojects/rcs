      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4 flex-shrink-0">
            ...
            <a
              href="/"
              className="flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 bg-white bg-opacity-90 hover:bg-opacity-100 text-sky-600 hover:text-sky-700 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
              title="Home"
            >
            ...
            <div className="relative">
              ...
              {isMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-64 sm:w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50 max-h-96 overflow-y-auto">
                    
                    {/* Menu Items */}
                    <a
                      href="/create"
                      className="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-sky-50 hover:text-sky-700 transition-colors duration-200"
                      onClick={toggleMenu}
                    >
