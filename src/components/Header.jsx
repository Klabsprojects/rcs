...
const Header = () => {
  ...
  const getNavigationButtons = () => {
    ...
    if (userRole === 'rcs-admin') {
      ...
      // For indent: show Indent Raising, GRN, and Menu Attendance
      buttons.push(
        <a
          key="indent-raising"
          href="/indent"
      ...
      // For ind-apr: show menu items with indents
      buttons.push(
        <a
          key="menu-item-1"
          href="/indent-approval"
          className="flex items-center space-x-2 pl-6 px-3 py-2 text-black hover:text-gray-700 hover:bg-sky-500 hover:bg-opacity-20 rounded-lg transition-all duration-200"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
          </svg>
          <span className="font-medium text-sm">Indent Approval</span>
        </a>
      );

     
    } else if (userRole === 'ind-apr') {
      // For ind-apr: show indented menu items
      buttons.push(
        <a
          key="indent-approval"
          href="/indent-approval"
          className="flex items-center space-x-2 pl-8 px-3 py-2 text-black hover:text-gray-700 hover:bg-sky-500 hover:bg-opacity-20 rounded-lg transition-all duration-200 border-l-4 border-sky-600"
          role="ind-apr"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      buttons.push(
        ...
        >
          ...
          <span className="font-medium text-sm">Approval History</span>
        </a>
      );
            ...
            <div className="relative hidden md:block">
              ...
              {isProfileOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                    {/* Logout Button for Profile Dropdown */}
                    <button
                      onClick={handleLogout}
                      className="w-full flex items-center space-x-3 px-4 py-3 text-red-600 hover:bg-red-50 transition-colors duration-200"
                    >
